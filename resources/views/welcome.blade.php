                                    ...
                                    <div class="row d_flex">
                                        ...
                                        <div class="col-md-6">
                                            <div class="bluid">
                                                ...
                                                <p>We measure our success by the satisfaction of our customers. Ethereum asset is a return optimizer that provides a key solution for investment managers that combines institutional-grade technology with strong industry experience and a deep understanding of our clients' needs and goals. .
                                                </p>
                                                <a class="read_more" href="{{ route('register') }}">Register Now </a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
